...
\begin{tabular}{>{\bfseries}p{2.5cm}p{\linewidth-2.5cm\relax}}
	...
	and \href{https://www.gfdl.noaa.gov/}{NOAA Geophysical Fluid Dynamics Laboratory}\par
...
\begin{enumerate}
    ...
    \item \normalsize{\bf{\underline{Tseng K.-C}}}., N. C. Johnson., E. D. Maloney, E. A. Barnes, and S. B. Kapnick: Mapping Large-scale Climate Variability to Hydrological Extremes: An Application of the Linear Inverse Model to Subseasonal-to-Seasonal prediction (to be submitted) 	
