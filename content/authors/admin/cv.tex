...
\begin{tabular}{>{\bfseries}p{2.5cm}p{\linewidth-2.5cm\relax}}
	2019  --   & Postdoc -
	\href{https://www.princeton.edu/}{Program in Atmospheric and Oceanic Science, Princeton University}\par 
...
\begin{enumerate}
    ...
    \item \normalsize{\bf{\underline{Tseng K.-C}}}., and co-authors: Seasonal forecast of atmospheric river with GFDL-Seamless System for Prediction and Earth System Research (SPEAR) model (to be submitted)\par
	...
	\item Bohar Singh, Eric D. Maloney and \normalsize{\bf{\underline{K.-C. Tseng}}}., : The influence of Tropospheric QBO on Madden-Julian Oscillations Teleconnections. (to be submitted)  \par
	...
	\item \normalsize{\bf{\underline{Tseng K.-C}}}., E. D. Maloney and E. A. Barnes, : The consistency of MJO teleconnection patterns on interannual timescales \textit{J. Climate} 
