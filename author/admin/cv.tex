...
\normalsize{\bf{2025}} 
\begin{enumerate} 
	\item \normalsize{\bf{\underline{K.-C. Tseng}}} et al. 2025: Aerial River Drainage Mechanism: A
Semi-Analytical Approach (in preparation)
	\item W. Weng., et al. (\normalsize{\bf{\underline{K.-C. Tseng}}}) 2025: Aerial river drainage: hydrological boundaries from long-term continental moisture flows (Nature Communication, in-revision)
Predictability of Liouville flow
	\item R. Kuo.,* and \normalsize{\bf{\underline{K.-C. Tseng}}} 2025: An Entropy–Divergence Framework for Quantifying
Predictability of Liouville flow
