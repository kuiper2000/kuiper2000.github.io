...
\normalsize{\bf{2022}} 
\begin{enumerate}  
	\item \normalsize{\bf{\underline{Tseng K.-C}}}., and co-authors 2022: The multiseasonal forecast of CONUS tornado activity and the optimal environment for severe weather (in preparation, to be submitted)
	\item Jia, L., and \normalsize{\bf{\underline{co-authors}}} 2022: Skillful seasonal prediction of North American summertime hot extremes (in press)
	\item \normalsize{\bf{\underline{Tseng K.-C}}}., and co-authors 2022: When will humanity notice its influence on atmospheric rivers? (submitted) \par
	\item Bushuk, M., and \normalsize{\bf{\underline{co-authors}}} 2022: Mechanisms of Regional Artic Sea Ice Predictability in Dynamical Seasonal Forecast Systems (in press)
