...
\begin{tabular}{>{\bfseries}p{4cm}p{\linewidth-2.5cm\relax}}
	...
	Graduated with Honors and completed the degree in 3yrs\par
	\\
...
\begin{enumerate}
	...
	\item Zhang, L., and \normalsize{\bf{\underline{co-authors}}}: Using large ensembles to elucidate the possible roles of Southern Ocean meridional overturning circulation in the Southern Ocean 36-yr SST trend (to be submitted)
