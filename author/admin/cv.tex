...
\begin{enumerate}
	...
	\item Bushuk, M., and \normalsize{\bf{\underline{co-authors}}}: Seasonal prediction and predictability of regional Antarctic sea ice (submitted to Earth and Space Science Open Archive (ESSOAr)) \par
    ...
    \item \normalsize{\bf{\underline{Tseng K.-C}}}., and co-authors: Seasonal Prediction of western North America Atmospheric Rivers (submitted to PNAS)\par
